		...
		namespace Details {
			...
			public:
			    ...
			    static bool isInterfaceSupported(const Antilatency::InterfaceContract::InterfaceID& id) {
					if (id == Antilatency::StereoGlasses::ICotask::VMT::ID()) {
						return true;
					}
	...
	namespace InterfaceContract {
		namespace Details {
			...
			public:
			    InterfaceRemap() = default;
			    static bool isInterfaceSupported(const Antilatency::InterfaceContract::InterfaceID& id) {
					if (id == Antilatency::StereoGlasses::ICotaskConstructor::VMT::ID()) {
						return true;
					}
	...
	namespace InterfaceContract {
		namespace Details {
			...
			public:
			    InterfaceRemap() = default;
			    static bool isInterfaceSupported(const Antilatency::InterfaceContract::InterfaceID& id) {
					if (id == Antilatency::StereoGlasses::ILibrary::VMT::ID()) {
						return true;
					}
