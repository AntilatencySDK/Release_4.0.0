...
Git command to clone this subset: `git clone --branch subset-e53501262e121f0cecbd9d2bfa120d1a66f6fbfd --single-branch https://github.com/AntilatencySDK/Release_4.0.0.git AntilatencySDK`
