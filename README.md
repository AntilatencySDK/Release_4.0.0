...
Git command to clone this subset: `git clone --branch subset-d50c0e20c00d9a9930dec5cae5fbe9d7f4bd0b95 --single-branch https://github.com/AntilatencySDK/Release_4.0.0.git AntilatencySDK`
